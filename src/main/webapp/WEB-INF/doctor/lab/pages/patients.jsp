...
<div style="background-color: #ffffff;">
            <content>
                ...
                <div class="col-xl-5 col-lg-5 col-md-7 col-sm-5 pt-1 px-2 pb-2 mx-auto">
                        <form class="d-flex" id="search" method="GET" action="/lab/patients/searchTelephone_number">
                            ...
                            <a href="/lab/patients/1" class="btn btn_find_all">Всі</a>
                        </form>
                </div>
                ...
                <div class="table-wrapper-scroll-y my-custom-scrollbar">
                    ...
                    <table class="table tableFixHead">
                        <thead>
                        <tr>
                            <th>РНОКПП<a href="/lab/patients/1" class="btn btn-sm "><i class="bi bi-sort-down"></i></a></th>
                            <th>ПІП<a href="/lab/patients/2" class="btn btn-sm "><i class="bi bi-sort-down"></i></a></th>
                            <th>Стать<a href="/lab/patients/3" class="btn btn-sm "><i class="bi bi-sort-down"></i></a></th>
                            <th>Номер телефону<a href="/lab/patients/4" class="btn btn-sm "><i class="bi bi-sort-down"></i></a></th>
                            <th>Юзер</th>
