                        ...
                        <form action="${editUrl}" name="patient" method="POST">
                            <input type="hidden" name="id_visit" value="${id_visit}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="chronic_disease" class="form-control" placeholder="немає" value="${patient.chronic_disease}" maxlength="100" >
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="allergic_history" class="form-control"  placeholder="немає" value="${patient.allergic_history}" maxlength="100" >
                                    </div>
                                </div>
