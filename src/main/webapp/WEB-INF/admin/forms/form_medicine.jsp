            ...
            <div class="col-xl-7 col-lg-10 col-md-10 col-sm-10 mx-auto p-3 pt-3">
                <div class="card card_form shadow">
                    <div class="card-body ">
                        ...
                        <form:form action="/admin/add_medicineCatalog" method="POST" name="medicine"  class="was-validated">


                            <div class="row mb-3">
                                <label class="col-sm-6 col-form-label ln">ATX:</label>
                                <div class="col-sm-6">
                                    <input class="form-control " type="text" name="ATX" value="${medicine.ATX}" required>
                                </div>
                            </div>
                            ...
                            <center>
                                <c:if test="${empty medicine.ATX}">
                                    <input type="submit" id="in"  class="btn btn_add" name="add_medicine" value="Створити">
                                </c:if>
                                <c:if test="${!empty medicine.ATX}">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="text-center text-justify">
                                ...
                                <span class="ml-2" style="font-size:16pt;">Такий препарат вже існує</span>
                            </div>
