...
<nav id="" class=" sidebarMenu col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    ...
    <div class="position-sticky pt-3">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link"  href="/main_doctor/unit/1">
                    <div class="responsive__offer">
                        ...
                        <p class="responsive__offer-text">Підрозділи</p>
                    </div>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/main_doctor/family_doctor/1">
                    <div class="responsive__offer">
                        <div class="responsive__offer-icon">
                            <div class="c">
                        ...
                        <p class="responsive__offer-text">Сімейні лікарі</p>
                    </div>
                </a>
            </li>
