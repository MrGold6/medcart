            ...
            <div class="col-xl-7 col-lg-10 col-md-10 col-sm-10 mx-auto p-3 pt-3">
                <div class="card card_form shadow">
                    <div class="card-body ">
                        ...
                        <legend class="card-title text-center">Підрозділ</legend>


                        <form:form action="/main_doctor/add_unit" method="POST" name="unit"  class="was-validated">
                            ...
                            <center>
                                <c:if test="${unit.id==null}">
                                    <input type="submit" id="in"  class="btn btn_add" name="add_unit" value="Створити">
                                </c:if>
                                <c:if test="${unit.id!=null}">
