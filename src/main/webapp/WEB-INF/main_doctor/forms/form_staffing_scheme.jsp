        ...
        <content class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="col-xl-7 col-lg-10 col-md-10 col-sm-10 mx-auto p-3 pt-3">
                <div class="card card_form shadow">
                    <div class="card-body ">
                        <c:if test="${staffingScheme.number==0}">
                            <title>Add</title>
                        </c:if>
                        <c:if test="${staffingScheme.number!=0}">
                            <title>Edit</title>
                        ...
                        <form:form action="/main_doctor/add_staffing_scheme" method="POST" name="staffingScheme"  class="was-validated">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" type="number" name="number" value="${staffingScheme.number}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="count" class="form-control" value="${staffingScheme.count}" required>
                                </div>
                            </div>
